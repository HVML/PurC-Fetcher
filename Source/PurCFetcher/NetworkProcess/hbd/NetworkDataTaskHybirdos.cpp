...
NetworkDataTaskHybirdos::~NetworkDataTaskHybirdos()
{
    m_session->unregisterNetworkDataTask(*this);
}

String NetworkDataTaskHybirdos::suggestedFilename() const
{
...
void NetworkDataTaskHybirdos::setPendingDownloadLocation(const String& filename, SandboxExtension::Handle&& sandboxExtensionHandle, bool allowOverwrite)
{
    NetworkDataTask::setPendingDownloadLocation(filename, WTFMove(sandboxExtensionHandle), allowOverwrite);
}

void NetworkDataTaskHybirdos::cancel()
{
...
void NetworkDataTaskHybirdos::resume()
{
...
void NetworkDataTaskHybirdos::invalidateAndCancel()
{
}

NetworkDataTask::State NetworkDataTaskHybirdos::state() const
{
    return m_state;
}

void NetworkDataTaskHybirdos::dispatchDidCompleteWithError(const ResourceError& error)
{
...
void NetworkDataTaskHybirdos::dispatchDidReceiveResponse()
{
...
void NetworkDataTaskHybirdos::createRequest(WebCore::ResourceRequest&& request)
{
    m_currentRequest = WTFMove(request);
    m_startTime = MonotonicTime::now();
}

void NetworkDataTaskHybirdos::sendRequest()
{
    runCmdInner();
    buildResponse();
...
void NetworkDataTaskHybirdos::runCmdInner()
{
    m_readBuffer.clear();
...
void NetworkDataTaskHybirdos::runCmdOuter()
{
}

void NetworkDataTaskHybirdos::buildResponse()
{
...
void NetworkDataTaskHybirdos::parseQueryString(String query)
{
    if (query.isEmpty())
        return;
    ...
    {
        String decode = decodeEscapeSequencesFromParsedURL(params[i]);
...
void NetworkDataTaskHybirdos::parseCmdFilter(String cmdFilter)
{
...
String NetworkDataTaskHybirdos::parseCmdLine(String cmdLine)
{
    if (cmdLine.isEmpty())
        return cmdLine;
    ...
    int cmdLineLength = cmdLine.length();
    size_t end = start + 1;
