...
//     used outside of the component defining your class (e.g. your class is in xCore and it is also used in PurCFetcher). In this case, you can use WTF_MAKE_ISO_ALLOCATED_EXPORT
